...
class BudgetPayment():
    ...
    def show_payment(self):
        ...
        fname = "payments_{}.csv".format(self.ind_data["village"])
        paymentfilename = os.path.join(self.paymentsPATH, fname)

        colnames = ("wzbid", "enumid", "enumerator", "date", 
                    "tid", "vid", "taluk", "village",
                    "hh_name", "hh_name_corrected", 
                    "election_id", "election_corrected",
                    "rationcard_nr", "ration_corrected", 
                    "interviewed_name", "interviewed_election", "interviewed_ration")

        paynames = ("pay_treatment", "payment_1", "payment_2", "paydate_1", "paydate2")
        
        paydata = [self.ind_data.get(cname)
