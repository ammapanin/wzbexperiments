...
class budgetSetup():
    ...
    def write_data(self):
        ...
        data_name = "{}_{}_{}_{}.csv".format(*id_tags)
        data_path = os.path.join(self.dataPATH, data_name)
        ...
        with open(data_path, "w") as dfile:
            dwrite = csv.writer(dfile)
            [dwrite.writerow(row)
             for row in [data_colnames] + data]

        print "Experiment data written to ", data_name
        return None
